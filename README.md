...
Binrik Navigation Menu Designer stores configuration objects in the `binrik_nmd_menus` option key in the `wp_options` table. Supported settings keys are:
...
**Shiv Singh**  
GitHub: [@binrik](https://github.com/binrik)
